                            ...
                            <form class="cmxform" method="POST" action="{{ route('post_create') }}">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="maxlength-textarea" class="form-control" maxlength="100" rows="3" name="excerpt"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="maxlength-textarea" class="form-control"  rows="8" name="content"></textarea>
                                    </div>
                                    <div class="form-group">
